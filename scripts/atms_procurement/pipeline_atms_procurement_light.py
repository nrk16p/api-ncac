"""
Light variant ของ atms_procurement — ดึงเฉพาะ 7 วันล่าสุด (~3-4 นาที)
...
# window = 7 วันล่าสุด (Asia/Bangkok) + label แยก
_ict = datetime.utcnow() + timedelta(hours=7)
os.environ["ATMS_FROM_DATE"] = (_ict - timedelta(days=7)).strftime("%d/%m/%Y")
