...
class CaseReportInvestigate(Base):
    ...
    insurance_claim = Column(Numeric(12, 2))
    product_resellable = Column(Numeric(12, 2))
    remaining_damage_cost = Column(Numeric(12, 2))
    driver_cost = Column(Numeric(12, 2))
    company_cost = Column(Numeric(12, 2))
